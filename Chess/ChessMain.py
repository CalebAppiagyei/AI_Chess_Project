...
def main():
    ...
    humanPlaying = True # When the human is playing 
    ...
    while running:
        ...
        for e in p.event.get():
            ...
            # Mouse 
                ...
                if not gameOver and humanTurn: # If it is not the human's turn they should not be able to make a move
        ...
        if not gameOver and not humanTurn:
            aiMove = ChessBot.findRandomMove(gameState.getValidMoves()) # The ai will choose a random move 
